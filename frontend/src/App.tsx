...
const App: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content:
        "Hi! I'm your AI parenting assistant. Ask me anything about newborn care, feeding, sleep, or if you're worried about something - I'm here to help! 👶",
    },
  ]);
  ...
  const getFallbackResponse = async (userQuestion: string): Promise<string> => {
    ...
    if (
      ...
      return feedingResponses[
        Math.floor(Math.random() * feedingResponses.length)
      ];
    }

    // Crying questions
    if (
      question.includes('cry') ||
      question.includes('fussy') ||
      question.includes('calm') ||
      question.includes('soothe')
    ) {
      ...
      return cryingResponses[
        Math.floor(Math.random() * cryingResponses.length)
      ];
    }
    ...
    if (
      ...
      question.includes('worry') ||
      question.includes('concerned') ||
      question.includes('should i call') ||
      ...
      return normalResponses[
        Math.floor(Math.random() * normalResponses.length)
      ];
    }
  ...
  const handleSendMessage = async (): Promise<void> => {
    ...
    try {
      ...
      const errorMessage: Message = {
        role: 'assistant',
        content:
          "I'm having trouble right now, but I'm here to help! For immediate concerns, don't hesitate to contact your pediatrician. What would you like to discuss?",
      };
