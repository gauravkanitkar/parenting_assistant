...
// Chat endpoint
app.post('/api/chat', async (req: ChatRequest, res: Response<ChatResponse | ErrorResponse>) => {
  try {
...
app.listen(PORT, () => {
  ...
  console.log(`📱 Frontend URL: ${SecureEnvLoader.getFrontendUrl()}`);
  console.log(`🔑 OpenAI API Key: ✅ Configured (encrypted)`);
});